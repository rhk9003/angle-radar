...
6. **留言缺口**：從留言挖「觀眾想知道／想要，但這支影片沒講到或沒講清楚」的問題與需求，
   以及吵最兇的爭論——這就是別人可以補的內容缺口，最能拿去做「超越版」（沒有留言就寫「無」）
"""
...
- 「想蹭它」的招式庫：回應影片、補充觀點、關聯標題融合對方關鍵字、24-48 小時時效跟進、
  對方留言區的爭論與未解問題就是現成題目
- 「想超越它」的招式庫：**優先補上拆解裡「留言缺口」點出的、觀眾想要但這支片沒給的東西**、
  深挖對方沒講清楚的、只講概念你補實作步驟、換更在地的案例、
